...
const registerController= async(req,res)=>{
    try{
        ...
        if(exisitingUser){
            ...
            return res.status(200).send({message:'User Already Exisit', success:false})
        }
...
const userAppiontmentsController=async(req,res)=>{
    try{
...
module.exports={loginController,registerController,authController,
    ...
    bookingAvailabilityController,userAppiontmentsController
};